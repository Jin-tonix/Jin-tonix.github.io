...
`,X=d.a.li`
  ...
  column-gap: 16px;
  padding: 0 0 0 26px;
  margin-bottom: ${e=>{let{$kind:t}=e;return"tech"===t?"18px":"14px"}};
  ...
  &::before {
    ...
    border: 2px solid ${e=>{let{$kind:t}=e;return"tech"===t?x:E}};
  }

  .period {
    color: ${e=>{let{$kind:t}=e;return"tech"===t?x:w}};
    font-size: ${v.xs};
    font-weight: ${C.subhead};
  ...
  .org {
    color: ${e=>{let{$kind:t}=e;return"tech"===t?y:w}};
    font-size: ${e=>{let{$kind:t}=e;return"tech"===t?v.md:v.sm}};
...
`,ae=d.a.div`
  ...
  color: ${y};
  font-size: ${v.sm};
`,ne={"llm-agent":[Z.p,"#ffd700"],mcp:[Z.n,"#61DAFB"],rag:[Z.e,"#f29111"],litellm:[Z.n,"#6DB33F"],langfuse:[Z.a,"#F7DF1E"],hitl:[Z.r,"#E34F26"],"claude-code":[Z.c,"#DE7356"],java:[Z.j,"#007396"],spring:[ee.l,"#6DB33F"],mysql:[ee.e,"#4479A1"],jpa:[Z.e,"#f29111"],python:[ee.k,"#3776AB"],nextjs:[ee.g,"#fff"],node:[Z.m,"#339933"],fastapi:[ee.a,"#009688"],postgres:[ee.j,"#4169E1"],supabase:[ee.m,"#3ECF8E"],html:[Z.i,"#E34F26"],css:[Z.d,"#1572B6"],js:[Z.k,"#F7DF1E"],vue:[ee.o,"#4FC08D"],react:[Z.o,"#61DAFB"],flutter:[ee.b,"#02569B"],docker:[Z.f,"#2496ED"],git:[Z.g,"#F05032"],github:[Z.h,"#181717"],"docker-compose":[Z.f,"#2496ED"],"gh-actions":[ee.c,"#2088FF"],gcp:[ee.d,"#4285F4"],nginx:[ee.h,"#009639"],"zero-downtime":[Z.q,"#ffd700"],n8n:[ee.f,"#EA4B71"],"chrome-ext":[Z.b,"#4285F4"],playwright:[ee.i,"#2EAD33"],swift:[ee.n,"#F05138"]};var le=()=>{const{content:e}=h(),{skills:t}=e;return l.a.createElement(V,{title:t.title},t.groups.map(e=>l.a.createElement(K,{key:e.id,id:e.id+"-skills"},l.a.createElement(q,null,e.title),l.a.createElement(te,null,e.items.map(e=>{const[t,a]=ne[e.id]||[Z.c,y];return l.a.createElement(ae,{key:e.id},l.a.createElement(t,{size:"1.2em",color:a}),l.a.createElement("span",null,e.label))})))))};const re=d.a.div`
  display: grid;
...
`;function ie(e){let{metrics:t}=e;return t&&0!==t.length?l.a.createElement(re,null,t.map(e=>l.a.createElement(oe,{key:e.label},l.a.createElement("div",{className:"value"},e.value),l.a.createElement("div",{className:"label"},e.label)))):null}const se=d.b`
  0% {
    opacity: 0;
...
`;function de(){const{content:e}=h(),{hero:t}=e;return l.a.createElement(ce,null,l.a.createElement("div",{className:"headline"},t.headline),l.a.createElement("div",{className:"sub"},t.sub),l.a.createElement(ie,{metrics:t.metrics}))}const me=d.a.div`
  background-color: ${f};
  border: 1px solid ${E};
...
`;function Ee(e){let{systemMap:t,withPrefix:a}=e;return t?l.a.createElement(me,null,l.a.createElement(pe,null,t.title),l.a.createElement(ge,null,t.intro),t.image&&l.a.createElement(ue,{href:t.image,target:"_blank",rel:"noopener noreferrer"},l.a.createElement("img",{src:t.image,alt:t.imageAlt||t.title})),t.layers&&l.a.createElement(fe,null,t.layers.map(e=>l.a.createElement(l.a.Fragment,{key:e.name},l.a.createElement("dt",null,e.name),l.a.createElement("dd",null,e.desc)))),l.a.createElement(he,null,t.nodes.map(e=>l.a.createElement(be,{key:e.id,to:a("/projects/"+e.caseId)},e.label)))):null}const ye=d.a.div`
  display: grid;
...
`,Se=d.a.div`
  ...
  text-align: center;
  opacity: 0.9;
`;function Pe(){const{content:e,withPrefix:t}=h(),{nav:a,systemMap:n,cases:r,before:o}=e;return l.a.createElement(V,{title:a.projects},l.a.createElement(K,null,l.a.createElement(Ee,{systemMap:n,withPrefix:t})),l.a.createElement(K,null,l.a.createElement(q,null,"StyleSeller \xb7 2026"),l.a.createElement(ye,null,r.map(e=>l.a.createElement(xe,{key:e.id},l.a.createElement(ve,{to:t("/projects/"+e.slug)},l.a.createElement("img",{src:e.logo,alt:e.title})),l.a.createElement(Ae,null,e.shortTitle))))),l.a.createElement(K,null,l.a.createElement(q,null,o.title),l.a.createElement(J,null,o.intro),l.a.createElement(we,null,o.projects.map(e=>l.a.createElement(ke,{key:e.route},l.a.createElement(Ce,{to:t(e.route)},l.a.createElement("img",{src:e.logo,alt:e.title})),l.a.createElement(Ae,null,e.title),l.a.createElement(Se,null,e.connection))))))}const Ie=d.a.div`
  width: 100%;
  display: flex;
  justify-content: center;
  background-color: ${b};
...
`;function Le(e){let{text:t}=e;return l.a.createElement(Ie,null,l.a.createElement(je,null,t))}const $e=d.a.div`
  width: 100%;
  min-height: 100%;
  display: flex;
  justify-content: center;
