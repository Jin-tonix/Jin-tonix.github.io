...
`;function ce(e){let{metrics:t}=e;return t&&0!==t.length?l.a.createElement(ie,null,t.map(e=>l.a.createElement(se,{key:e.label},l.a.createElement("div",{className:"value"},e.value),l.a.createElement("div",{className:"label"},e.label)))):null}const de=d.b`
  0% {
    opacity: 0;
...
`,me=d.a.div`
  ...
  .headline {
    ...
    color: ${y};
    margin-bottom: 12px;
    animation: ${de} 0.8s ease forwards;
...
`;function pe(){const{content:e}=h(),{hero:t}=e;return l.a.createElement(me,null,l.a.createElement("div",{className:"headline"},t.headline),l.a.createElement("div",{className:"sub"},t.sub),l.a.createElement(ce,{metrics:t.metrics}))}const ge=d.a.div`
  background-color: ${f};
  border: 1px solid ${E};
...
`,ve=d.a.div`
  ...
  width: 100%;
  text-align: center;
`,Ce=Object(d.a)(ve)``,Ae=Object(d.a)(p.b)`
  width: 100%;
  aspect-ratio: 4 / 3;
  background-color: ${f};
  border: 1px solid ${E};
...
`;function Me(e){let{text:t}=e;return l.a.createElement(Le,null,l.a.createElement($e,null,t))}const Te=d.a.div`
  width: 100%;
  min-height: 100%;
  display: flex;
  justify-content: center;
