...
`;function de(e){let{metrics:t}=e;return t&&0!==t.length?l.a.createElement(ce,null,t.map(e=>l.a.createElement(me,{key:e.label},l.a.createElement("div",{className:"value"},e.value),l.a.createElement("div",{className:"label"},e.label)))):null}const pe=m.b`
  0% {
    opacity: 0;
...
`;function ue(){const{content:e}=h(),{hero:t}=e;return l.a.createElement(ge,null,l.a.createElement("div",{className:"headline"},t.headline),l.a.createElement("div",{className:"sub"},t.sub),l.a.createElement(de,{metrics:t.metrics}))}const he=m.a.div`
  background-color: ${f};
  border: 1px solid ${E};
...
`,Ae=m.a.div`
  ...
  width: 100%;
  text-align: center;
`,Se=Object(m.a)(Ae)``,Pe=Object(m.a)(p.b)`
  width: 100%;
  aspect-ratio: 4 / 3;
  background-color: ${f};
  border: 1px solid ${E};
...
`;function Re(e){let{text:t}=e;return l.a.createElement(Me,null,l.a.createElement(Te,null,t))}const Ge=m.a.div`
  width: 100%;
  min-height: 100%;
  display: flex;
  justify-content: center;
