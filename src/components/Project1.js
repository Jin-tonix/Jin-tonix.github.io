        ...
        <ContentSection>
          ...
          <TextSection>
            ...
            <Section>
              <h3>개발 관련 설명</h3>
              <p>
                본 프로젝트에서 관리자 페이지의 프론트/백엔드와 어플리케이션 구현을 담당하였습니다. 관리자 페이지는 URL을 통해 접근할 수 있도록 설정하였으며, 회원 수, 최근 가입한 유저, 일일 및 월별 사용자 수를 한눈에 쉽게 확인할 수 있도록 그래프를 활용해 시각화하였습니다. 그리고 앱은 Flutter를 이용해 만들고 백앤드와 연결하여 웹과 연동되게 하였습니다.
              </p>
              <p>
