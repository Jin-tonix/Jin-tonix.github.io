...
const ko = {
  ...
  cases: [
    ...
    },
    {
      ...
      tldr: [
        ...
        '실행 도구는 기본 드라이런인 Tool Registry 에 등록돼 있고, 지금 승인 뒤 실제로 실행되는 것은 이슈 생성·도구 멈춤입니다.',
      ],
      problem: [
  ...
  about: {
    ...
    paragraphs: [
      'SNS 커머스 스타트업 StyleSeller 에서 사내 AI 업무 시스템을 혼자 설계·개발·운영합니다. 2025.12 에 입사해 2026.02 부터 개발을 맡았고, 직책은 개발자(AI·자동화 전담·책임)입니다.',
      '만든 것은 다섯 갈래입니다. 거래처 카톡 문의에 근거로 답하는 벤더 CS 에이전트, 셀러 발굴부터 맞춤 발송까지 잇는 업무툴, 사람이 승인해야 움직이는 에이전트 조직 Spark·Work OS, 대표 메일 에이전트와 지식 허브, 그리고 API 가 없는 일을 직원 PC 에서 돌리는 설치·배포 체계입니다. 사용자는 사내 직원이고, 직원 11명의 PC 와 서비스 약 40개가 매일 돌아갑니다.',
      '코드는 Claude Code 에이전트 여러 개를 병렬로 지휘해 빠르게 만들고, 결과는 테스트·교차 리뷰·실기기 확인으로 검증합니다. 사고가 나면 원인과 교훈을 규칙으로 남겨 다음에 같은 실수가 나오지 않게 합니다.',
      '비전공 전환자입니다. 법학을 공부하고 영어 강사와 어린이집 운영실장으로 일하면서, 현장에서 일하는 사람의 불편을 먼저 듣는 습관이 생겼습니다. 원칙은 "반복은 기계에게, 판단은 사람에게" 입니다.',
    ],
    nowTitle: 'Now',
    now: [
