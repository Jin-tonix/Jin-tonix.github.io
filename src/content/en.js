...
const en = {
  ...
  about: {
    ...
    experience: [
      ...
      {
        org: 'We:Review · Intern',
        period: 'Aug–Oct 2025',
        bullets: [
          'Built the OCR + LLM pipeline for automated receipt processing',
          'Researched the stack: open-source licenses and performance comparisons',
          'Prompt engineering for structured (JSON) extraction',
        ],
      },
      { org: 'Korea IT Business Promotion Association', period: 'May–Jul 2025', bullets: ['Generative AI developer program'] },
      {
